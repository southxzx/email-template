            ...
            <td>
              <div>
                <div className="logo" style={{ display: "flex" }}>
                  ...
                  <a style={{ marginRight: '30px' }} target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/haontran/"><img style={{ width: "30px" }} src="https://ci5.googleusercontent.com/proxy/kozm-3AwfYwj3Sy0j4tkMfBlgXmMaOXUJUyuiJK2GK4xA-d8H6wNngjwIeOlxYmJtxF5gCJHTLENMmMJ2ksEJw=s0-d-e1-ft#https://i.postimg.cc/6pTTcJz6/Linkedin-03.png" /></a>
                </div>
              </div>
            </td>
          </tr>
